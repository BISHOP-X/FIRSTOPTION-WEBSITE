...
const routes = [
  ...
  },
  {
    ...
    title: 'Add Money to FirstOption With Your Permanent Funding Account',
    description: 'Create your permanent funding account from a FirstOption payment or service screen. Transfer anytime and keep your payment details saved.',
    ogDescription: 'Add money to FirstOption and continue the same payment with your recipient and amount saved.',
    twitterDescription: 'Create one permanent funding account and reuse it for FirstOption payments, purchases and bills.',
  },
